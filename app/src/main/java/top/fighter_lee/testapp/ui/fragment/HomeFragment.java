...
public class HomeFragment extends BaseFragment {
    ...
    protected void init() {
        ...
        //加载需要显示的网页
        //设置Web视图
        wvWeb.loadUrl("https://m.500zhongcai.com/v1.0/act/mojo/app_1489417349333_common_index.html?_=_&_from=login&showwxpaytitle=1&rcode=1507966511626&loginStep=1&__ltime=1507966512535_1507966511957_0");
        wvWeb.setWebViewClient(new WebViewClient() {
            @Override
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                view.loadUrl("https://m.500zhongcai.com/v1.0/act/mojo/app_1489417349333_common_index.html?_=_&_from=login&showwxpaytitle=1&rcode=1507966511626&loginStep=1&__ltime=1507966512535_1507966511957_0");
