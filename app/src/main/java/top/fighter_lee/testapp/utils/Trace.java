    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && App.context.getExternalCacheDir() != null)
                dir = App.context.getExternalCacheDir() + File.separator + "log" + File.separator;
            else {
                dir = App.context.getCacheDir() + File.separator + "log" + File.separator;
            }
        }

        public Builder setLogSwitch(boolean logSwitch) {
            Trace.sLogSwitch = logSwitch;
            return this;
        }

        public Builder setGlobalTag(String tag) {
            if (!isSpace(tag)) {
                Trace.sGlobalTag = tag;
                sTagIsSpace = false;
            } else {
                Trace.sGlobalTag = "";
                sTagIsSpace = true;
